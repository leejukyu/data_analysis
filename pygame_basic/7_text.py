...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/data_analysis/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size # 이미지의 크기를 구해옴, rect : 사각형
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = (screen_width - enemy_width)/ 2 # 화면 가로의 절반에 위치
enemy_y_pos = (screen_height - enemy_height)/2 # 화면 세로 가장 아래에 위치
...
while running:
    ...
    # 경과시간(ms)을 1000단위로 나눠서 초(s) 단위로 표시
